...
const MentionLink = ({ href, children }) => {
    ...
    // Lấy UUID từ href (ví dụ: /profile/XB1p1TCgPwf2TBLOKA9lszZnP4Z2)
    // Regex hỗ trợ cả UUID chuẩn (lowercase + hyphens) và Firebase UUID (alphanumeric)
    const uuidMatch = href.match(/\/profile\/([a-zA-Z0-9-_]+)/);
