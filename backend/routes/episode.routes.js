...
// @route   POST /api/episodes/upload
// @desc    Upload video và bắt đầu transcode
// @access  Private/Admin
router.post('/episodes/upload', verifyToken, authorizeRoles('admin'), uploadVideo.single('video'), videoController.uploadVideo);

// @route   GET /api/episodes/job/:jobId
// @desc    Kiểm tra trạng thái job transcode
// @access  Private/Admin
router.get('/episodes/job/:jobId', verifyToken, authorizeRoles('admin'), videoController.getJobStatus);
