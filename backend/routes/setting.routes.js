...
router.delete('/login-history/:id', verifyToken, settingController.revokeLoginSession);
router.post('/revoke-all-sessions', verifyToken, settingController.revokeAllOtherSessions);
